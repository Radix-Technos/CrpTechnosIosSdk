...
- (void)receiveConnectConfirm:(NSInteger)state;
...
@property (nonatomic) NSInteger distance;
@property (nonatomic) NSInteger kcal;
- (nonnull instancetype)initWithType:(enum CRPSportState)type heartRate:(NSInteger)heartRate step:(NSInteger)step sportTime:(NSInteger)sportTime distance:(NSInteger)distance kcal:(NSInteger)kcal OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

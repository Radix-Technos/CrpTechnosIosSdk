...
@protocol CRPSSZipArchiveDelegate;

@interface CRPSSZipArchive : NSObject
...
+ (BOOL)unzipFileAtPath:(NSString *)path toDestination:(NSString *)destination delegate:(nullable id<CRPSSZipArchiveDelegate>)delegate;
...
+ (BOOL)unzipFileAtPath:(NSString *)path
          toDestination:(NSString *)destination
              overwrite:(BOOL)overwrite
               password:(nullable NSString *)password
                  error:(NSError * *)error
               delegate:(nullable id<CRPSSZipArchiveDelegate>)delegate NS_REFINED_FOR_SWIFT;
...
+ (BOOL)unzipFileAtPath:(NSString *)path
     ...
     preserveAttributes:(BOOL)preserveAttributes
              overwrite:(BOOL)overwrite
               password:(nullable NSString *)password
                  error:(NSError * *)error
               delegate:(nullable id<CRPSSZipArchiveDelegate>)delegate;
...
@protocol CRPSSZipArchiveDelegate <NSObject>
